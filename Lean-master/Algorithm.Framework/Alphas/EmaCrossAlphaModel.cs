...
namespace QuantConnect.Algorithm.Framework.Alphas
{
    ...
    public class EmaCrossAlphaModel : AlphaModel
    {
        ...
        public EmaCrossAlphaModel(int fastPeriod = 12,int slowPeriod = 26,Resolution resolution = Resolution.Daily)
        {
        ...
        public override IEnumerable<Insight> Update(QCAlgorithmFramework algorithm, Slice data)
        {
            ...
            foreach (var symbolData in _symbolDataBySymbol.Values)
            {
                ...
                {
                    algorithm.Plot(symbolData.Symbol.ToString(), "EMA Fast", symbolData.Fast.Current.Value);
                    algorithm.Plot(symbolData.Symbol.ToString(), "EMA Slow", symbolData.Slow.Current.Value);
