...
configOanda = open('**\Oanda.config','r')
GSheet, Token, accountID, *rest = configOanda.read().splitlines()
configOanda.close()

Token = "701af344c2a3d5d316f9135d1b0f1207-cf7842143ac3e4492b409aa303a9cc8c"
accountID = "101-004-17169350-002"
...
idx.to_csv("IdxHistory.csv",index=True,header=True)
idx.to_json("IdxHistory.json",index=True)
...
M1 = returns(20)
M1.to_csv("Dashboards\M1.csv",index=False,header=True)
M3 = returns(60)
